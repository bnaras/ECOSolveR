...
ifdef USE_LONG
CFLAGS = -O2 -Wall -DCTRLC=1 -Wextra -fPIC -DLDL_LONG -DDLONG -Iinclude -Iexternal/ldl/include -Iexternal/amd/include -Iexternal/SuiteSparse_config 
LDL = ldll.o
AMD = amd_l*.o amd_global.o
else
CFLAGS = -O2 -Wall -DCTRLC=1 -Wextra -fPIC -Iinclude -Iexternal/ldl/include -Iexternal/amd/include -Iexternal/SuiteSparse_config 
LDL = ldl.o
